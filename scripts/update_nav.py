...
nav_html = """
    <nav class="app-nav">
        <a class="nav-link" href="campuses.html">Select Campus</a><span style="color: #ccc; padding: 6px;">|</span><a class="nav-link" href="index.html">Dashboard</a>
        ...
        <a class="nav-link" href="community_impact.html">Community Impact</a>
    </nav>
"""
